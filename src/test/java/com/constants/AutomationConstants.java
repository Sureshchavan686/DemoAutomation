...
public class AutomationConstants {
	...
	public static final String ChromeDriver ="src//test//resources//Webdrivers//chromedriver.exe";
	public static final String FirefoxDriver = "src//test//resources//Webdrivers//geckodriver.exe";
	public static final String IEDriver = "src//test//resources//Webdrivers//IEDriverServer.exe";
